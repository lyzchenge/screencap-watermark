...
final class SettingsViewModel {
    ...
    var watermarkEnabled: Bool {
        ...
        set { settings.watermarkEnabled = newValue }
    }

    /// Watermark text
    var watermarkText: String {
        get { settings.watermarkText }
        set { settings.watermarkText = newValue }
    }

    /// Watermark font size ratio as percentage (1-10%)
    var watermarkFontSizePercent: Double {
        get { settings.watermarkFontSizeRatio * 100 }
        set { settings.watermarkFontSizeRatio = newValue / 100 }
    }

    /// Watermark opacity percentage (5-100%)
    var watermarkOpacityPercent: Double {
        get { settings.watermarkOpacity * 100 }
        set { settings.watermarkOpacity = newValue / 100 }
    }
    ...
    /// Valid range for watermark font size
    static let watermarkFontSizeRange: ClosedRange<Double> = 1.0...10.0
